    ...
    <div className={`min-h-screen transition-colors ${isDark ? 'bg-black text-white' : 'bg-white text-neutral-900'}`}>
      ...
      <section className={`pt-36 pb-20 px-6 relative overflow-hidden text-center`}>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 bg-[#FFC928]/15 border border-[#FFC928]/35 px-4 py-1.5 rounded-full text-[10px] sm:text-xs font-black text-[#FFC928] uppercase tracking-widest leading-none">
            🏆 Competição Anual Oficial Meu Ovo
          </div>
          ...
          <p className="text-lg md:text-xl font-display font-semibold max-w-2xl mx-auto leading-relaxed text-gray-400">
            A celebração anual da comida de verdade. Uma competição onde a austeridade e o sigilo protegem o seu negócio enquanto premiam os melhores sabores de São Paulo.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className={`p-8 rounded-[2.5rem] border ${isDark ? 'bg-[#0a0a0a] border-white/5' : 'bg-[#F9F9F9] border-gray-100'} text-left space-y-4`}>
            ...
            <p className="text-sm text-gray-500 leading-relaxed font-semibold">
              Ao final do ciclo anual (dia 15 de Dezembro), apenas os <strong>3 primeiros colocados generais</strong> serão divulgados publicamente na plataforma com destaque e troféus. O restante da lista permanecerá sob sigilo perpétuo.
            </p>
          </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 leading-relaxed mt-1 font-medium">
                  A votação popular anual de Ovos de Ouro abre no dia <strong>1 de Janeiro</strong> e encerra de forma automática pelo nosso servidor no dia <strong>10 de Dezembro</strong>. Clientes votam de forma segura ao final de seus pedidos reais.
                </p>
              </div>
            </div>
