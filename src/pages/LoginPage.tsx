      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-[2rem] shadow-xl shadow-black/5 p-8 space-y-5 border border-gray-100">
          ...
          >
            ...
            {isRestaurant ? 'Cadastrar com Google' : 'Criar conta com Google'}
          </button>

          <div className="relative">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-gray-200" /></div>
            <div className="relative flex justify-center"><span className="bg-white px-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">ou cadastre-se com e-mail</span></div>
          </div>
            </>
          )}
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-gray-200" /></div>
            <div className="relative flex justify-center"><span className="bg-white px-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">ou entre com</span></div>
          </div>
